...
BlobDetector::BlobDetector(const cv::SimpleBlobDetector::Params& parameters) : params_(parameters) {}
//BlobDetector::BlobDetector(const cv::SimpleBlobDetector::Params& parameters){}
cv::Ptr<BlobDetector> BlobDetector::create(const cv::SimpleBlobDetector::Params& params)
{
  //BlobDetector a(params);
  //new BlobDetector(params);//BlobDetector(params)
